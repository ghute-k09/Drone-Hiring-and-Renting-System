...
const EditUser = () => {
  ...
  useEffect(()=>{
      ...
      .then(result=>{
          ...
          setOp(result);
          setOperator_id(result.operator_id)
  ...
  const editUser = () => {
    const url = `http://localhost:8181/editOperator`
    swal(" Successfully Updated!", "You clicked the button!", "success");
     const body={operator_id,
      fname,
      mname,
      lname,
      email, 
  ...
  return (
    <div className='container'>
          ...
          <div className='mb-3' style={{ textAlign: 'center' }}>
            ...
            <Link to="/operator_home">        <button className="btn btn-success">  Back </button></Link>
